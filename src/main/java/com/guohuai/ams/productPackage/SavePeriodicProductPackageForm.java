...
@NoArgsConstructor
@AllArgsConstructor
public class SavePeriodicProductPackageForm implements Serializable {
...
//	@NotNull(message = "募集总份额不能为空")
	...
	@NotEmpty(message = "募集期到期前几小时内不能上架不能为空")
	...
	@Enumerations(values = {ProductPackage.Product_dateType_T, ProductPackage.Product_dateType_D}, message = "投资日类型错误")
	private String investDateType;
	
	@NotEmpty(message = "发布渠道不能为空")
	private String[] channelOids;//发布渠道
	...
	private Integer relateGuess;//是否关联竞猜活动（0：未关联，1：已关联）
	
	private String guessOid;//关联的新的竞猜活动oid
	
	private String guessOldOid;//关联的就得竞猜活动oid
