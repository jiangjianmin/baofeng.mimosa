 ...
 */
@Entity
@Table(name = "T_GAM_PRODUCT_PACKAGE")
@Data
...
//	private String type;
	 ...
	 * 产品包包含的单个产品份额
	 */
	private BigDecimal singleProductVolume=new BigDecimal(0);
	 ...
	 * 产品扩展标签
	 */
	private String productExpandLabel;
	
	/**
	 * 所属竞猜活动
	 */
	@ManyToOne(fetch = FetchType.EAGER)//懒加载当不在一个事物里session关闭会报错
