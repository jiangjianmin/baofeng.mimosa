...
@Data
public class ProfitClientRep<E> implements Serializable {
    ...
    private BigDecimal totalAmount;// 累计奖励金额
    private BigDecimal toPayAmount;// 待结算金额
    private BigDecimal payAmount;// 已打款金额
