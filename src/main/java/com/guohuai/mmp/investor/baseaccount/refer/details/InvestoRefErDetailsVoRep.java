...
/**
 * 
 * @ClassName: InvestoRefErDetailsVoRep
 * @Description: 分页对象
 * @author yihonglei
 ...
 */
@Data
public class InvestoRefErDetailsVoRep<E> implements Serializable {
    ...
    private String registNum;// 注册人数
	private String bindBankNum;// 绑卡人数
     ...
     */
    public InvestoRefErDetailsVoRep() {
    	total = -1;
    	totalPage = -1;
