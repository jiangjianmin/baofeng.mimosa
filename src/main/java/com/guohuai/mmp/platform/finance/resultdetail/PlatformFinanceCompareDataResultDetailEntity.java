...
@Entity
@Table(name = "T_MONEY_CHECK_COMPAREDATA_RESULT_DETAILS")
@EqualsAndHashCode(callSuper = false)
@NoArgsConstructor
public class PlatformFinanceCompareDataResultDetailEntity extends UUID{
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 6959808038170739717L;
	/** 对账Oid */
